	...
	return (
		...
		>
			<svg
				...
				viewBox="0 0 24 24"
				class="fill-accessibility active:fill-text-primary hover:fill-text-primary group-disabled:fill-text-primary h-full transition-colors duration-500 select-none"
			>
